...
namespace GridObjectSystem.AbilitySystem
{
    ...
    public class Ability : IAbilityFunctioner
    {
        ...
        protected bool isDebuff = false;//是否是负面效果
        ...
        protected bool canStack = true;//能否叠加,当前字段为负数时,当前能力最多只能有一层
        public bool CanStack
        {
            get => canStack; 
            set => canStack = value; 
        }
        protected bool canNegative = true;//能否为负数
        public bool CanNegative
        {
            get => canNegative; 
            set => canNegative = value; 
        }
        protected string abilityName = "";//能力名称
