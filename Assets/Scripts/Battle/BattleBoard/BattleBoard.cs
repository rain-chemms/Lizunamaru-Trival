...
public class BattleBoard : MonoBehaviour
{
    ...
    public List<BattleGrid> GetBattleGridList() => battleGridList;
    public List<BattleGrid> GetBattleGridList_Copy() => battleGridList.ToList();
    [SerializeField] private Vector2 gapsOfGrid = Vector2.one;//格子之间的间隔
    public Vector2 GetGapsOfGrid() => gapsOfGrid;
    
    public void SetGapsOfGrid(Vector2 gapsOfGrid) => this.gapsOfGrid = gapsOfGrid;
