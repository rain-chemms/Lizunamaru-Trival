...
public class CanvasMainCameraTowardsFunctioner : MonoBehaviour
{
    ...
    [SerializeField] private bool instantChange = false;//是否立即变换位置
    public bool IsInstantChange() => instantChange;
    public void SetInstantChange(bool newInstantChange) => instantChange = newInstantChange;
